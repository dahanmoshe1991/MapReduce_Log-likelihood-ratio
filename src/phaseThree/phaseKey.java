...
public class phaseKey  implements WritableComparable<phaseKey> {
    ...
    public phaseKey(Text w1, Text w2,IntWritable decade) {
        this.w1 = new Text(w1.toString());
        this.w2 = new Text(w2.toString());
        this.decade = new IntWritable(decade.get());
    }

    public phaseKey(String w1, String w2, String dec) {
        this.w1 =new Text(w1);
        this.w2 = new Text(w2);
        this.decade = new IntWritable(Integer.parseInt(dec));
    }

    public int gethashCode() {
        return w1.hashCode() + decade.hashCode();
    }
